...
function App() {
  return (
    <div className="container-principal">
      <div className="secao">
        <img className="imagem-logotipo" src="/logo.png" alt="Logotipo Padaria Plus" />
        <p>
      ...
      <div className="secao" id="sobre">
        <h1>O melhor de nossos pães e bolos para você</h1>
        <h2>Desde 2001, o lugar mais gostoso da cidade</h2>
        <img className="imagem-banner" src="/produtos-padaria.jpg" alt="produtos" />
      </div>

      <div className="secao secao-destaque" id="produtos">
      ...
      <div className="secao" id="contato">
        <h3>Contato</h3>
